//Contract Address Ropsten = 0xCeC8398a3D273a7940caD7423E9f7a529308949f
...
contract Dbill is Ownable, ERC721 {
    ...
    constructor() 
    ERC721(_tokenName = "Dbill",_tokenSymbol = "DBL"){
    salePrice = _salePrice;
    _salePrice = 1000000000000000000;
    ...
    function buyNft(uint quantity) external payable {
        ...
        require(block.timestamp >= SaleStart && block.timestamp <= SaleStart + 30 days, "Sale Time is Over");
        require(msg.value == _salePrice * quantity,"Invalid amount!");
